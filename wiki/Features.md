...
- **Fixed schedule (no drift)**: due dates follow a fixed grid anchored at the routine's creation date — completing early or late never shifts the series. "Every Monday" stays Monday, "the 5th" stays the 5th, no matter when you actually check it off. (Weekly day is set via the "On" dropdown; monthly anchors to the creation day-of-month.) A missed cycle shows up as a single overdue task, not a pile.
