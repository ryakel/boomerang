...
- **Link it to Trello** from the list's own settings: pick board → list → card → checklist, all in-app. No card IDs, no leaving the app. Unlinking only stops syncing — nothing is removed from the Trello card.
