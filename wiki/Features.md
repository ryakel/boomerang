...
- **Historic suggestions** *(planned)*: a weekly server scan over 12 months of completed-task history will detect recurring patterns and surface them as a new `routine_suggestion` notification type.
