...
- [ ] **Notion DB sync configuration** in v2 Settings — parent-page picker, database picker, sync-now controls. The per-task Notion search/link/create flow already landed (see entry below).
