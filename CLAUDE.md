...
**Roadmap:** Phase 2 Share Extension (built on branch, PR #660, awaiting Mac build-test) → Phase 3 App Intents (Siri/Shortcuts/Action button) → Phase 4b APNs full type coverage (centralized dispatcher). Paid Apple Developer Program required (App Groups + Push entitlement). Full build guide + Mac steps: `wiki/iOS-Native-App.md`.
