...
**Roadmap:** Phase 2 Share Extension (Swift → `POST /api/intake`, token shared via App Group) → Phase 3 App Intents (Siri/Shortcuts/Action button) → Phase 4 optional native APNs push + deep links. Full build guide + Mac steps: `wiki/iOS-Native-App.md`.
