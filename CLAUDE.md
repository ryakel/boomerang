...
- A dev-shaped server merges inbound but never writes back (`DEV_LIST_SYNC_WRITES=1` opts in); two servers fighting over one real family list looks exactly like a sync bug.
