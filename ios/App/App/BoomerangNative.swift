...
// Developer portal / Xcode "Signing & Capabilities → App Groups". If you change
// your bundle id, change this one string and the capability to match.
let boomerangAppGroup = "group.ryakel.boomerang"
