...
export function registerSettingsTools() {
  registerTool({
    ...
    execute: async () => {
      ...
      const redacted = { ...s }
      for (const k of ['anthropic_api_key', 'openai_api_key', 'notion_token', 'trello_api_key', 'trello_secret', 'gcal_client_secret', 'tracking_api_key', 'pushover_user_key', 'pushover_app_token']) {
  ...
  registerTool({
    ...
    execute: async (args) => {
      const BLOCKED = new Set(['anthropic_api_key', 'openai_api_key', 'notion_token', 'trello_api_key', 'trello_secret', 'gcal_client_secret', 'tracking_api_key', 'pushover_user_key', 'pushover_app_token'])
      const safe = {}
